...
$(document).ready(function () {
    ...
    var $fullscreenSlide = $('.js-fullscreen-section');
    var $window = $(window);
    var $navButtons = $('#js-fullscreen-section-nav  button');
    ...
    function checkSlidePosition(e) {
        ...
        try {
            for (var _iterator = $fullscreenSlide[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    function slideIsInTheView($slide) {
        var sectionId = $slide.attr('id');
        var $button = $('a[href="#' + sectionId + '"] > button');
...
$(document).ready(function () {
    ...
    var $input = $('input#postcode');
    var $form = $('#js-postcode-form');
    var $constituency = $('#js-mp-constituency');
    var $name = $('#js-mp');
    var $email = $('#js-mp-email');
    var $twiter = $('#js-mp-twitter');
    var ajaxSettings = {
        async: true,
        crossDomain: true,
        method: 'GET'
    ...
    function getConstituency(postcode) {
        ...
        ajaxSettings.method = 'GET';
        $.ajax(ajaxSettings).done(function (response) {
            var constituency = response.result[0].parliamentary_constituency;
    ...
    function renderMPConstituency(mp) {
        $constituency.show().find('dd').text(mp.constituency.replace(/\b\w/g, function (l) {
            return l.toUpperCase();
        }));
    }
    ...
    function decrypt(string) {
        if (string !== undefined) {
            var hash = string.substr(string.indexOf("#") + 1);
            var e,
                r,
                n,
                i,
